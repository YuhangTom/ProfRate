...
* We can give only the name of the instructor.

```{r}
get_tid(name = 'Brakor')
```

* we can give the name and department:
...
```{r}
sentiment_plot(url = "https://www.ratemyprofessors.com/ShowRatings.jsp?tid=902068", y = 2000, word = 'negative')
```
